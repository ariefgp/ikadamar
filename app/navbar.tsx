...
function Navbar(value: any) {
  return (
   <header className={`hidden md:flex md:flex-row-reverse gap-8 lg:gap-16 py-10 px-20 lg:py-16 lg:px-48 font-semibold bg-[${value.bgColor}] text-[#383333]`}> 
    <div>
    ...
    <div>
        <Link href="/#" className='hover:text-[#7791BA]'> Eyang Dasih </Link>
    </div>
    <div>
